 ...
 * 
 */
package org.sunbird.searchindex.elasticsearch;
...
import org.sunbird.searchindex.transformer.IESResultTransformer;
			...
			if (!jsonObjects.isEmpty()) {
				...
				for (String key : jsonObjects.keySet()) {
					...
					if (count % BATCH_SIZE == 0 || (count % BATCH_SIZE < BATCH_SIZE && count == jsonObjects.size())) {
						...
						System.out.println("Successfully Indexed Document ID");
